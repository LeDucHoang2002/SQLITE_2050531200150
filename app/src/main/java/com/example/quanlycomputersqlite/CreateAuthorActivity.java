package com.example.quanlycomputersqlite;
...
public class CreateAuthorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView imageView=(ImageView)findViewById(R.id.imgSignup);
        imageView.setOnClickListener(new View.OnClickListener(){
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(CreateAuthorActivity.this, MainActivity.class);
